...
{
    class TvSeriesGenreManagerService : BaseService, ITvSeriesGenreManager
    {
        public TvSeriesGenreManagerService(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        }
        ...
        /// <summary>
        /// Удаляет TV жанр у пользователя
        /// </summary>
        /// <param name="id">Id пользователя</param>
